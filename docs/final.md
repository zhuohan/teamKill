...
![Breadth First Search](v1.png){:class="img-responsive centered" height="50%" width="50%"}
...
![Breadth First Search](imp.png){:class="img-responsive centered" height="50%" width="50%"}
...
![Breadth First Search](12.png){:class="img-responsive centered" height="50%" width="50%"}
